...
public enum OS {
     ...
     *
     * @param aliases The aliases for the Operating-System.
     * @see #GetOS_Name()
     * @see #GetOS_Version()
    ...
    /**
     * Create's a formatted output String containing all the information about
     * the Operating-System.
     *
     * @return A formatted String, containing the name, version & architecture of
     ...
     *
     * @param os The Operating-System that should also be supported;
     */
     ...
     *
     * @param os The Operating-System that should be removed from the list of supported Operating-System's.
     */
